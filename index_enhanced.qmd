...
```
En el primer caso, como log(mu[,1]/mu[,4]) es menor a 0, sabemos que la probabilidad de que el usuario escoja la marca sunshine es menor que la probabilidad de escoger la marca private.
$\exp(-2.9901208)$ = `r exp(-2.9901208)`  
...
```
$\exp(-0.2839232)$ = `r exp(-0.2839232)`  
$\frac{0.007711103}{0.01024290}$ = `r 0.007711103 / 0.01024290`
